...
selection(MenuItems) ->
    ...
    PlistXml = os:cmd(io_lib:format("/Users/rajiv/My\\\ Apps/TextMate/TextMate.app/Contents/PlugIns/Dialog.tmplugin/Contents/Resources/tm_dialog -u -p \"~s\"", [ascii_plist(MenuItems)])),
